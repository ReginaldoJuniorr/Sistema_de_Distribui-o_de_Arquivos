...
- Bash git clone https://github.com/seu-usuario/seu-repositorio.git cd seu-repositorio Inicie o Servidor (Terminal 1):

- Bash python servidor.py O servidor ficará aguardando conexões na porta 65432.

Inicie o Cliente (Terminal 2):

- Bash python cliente.py Interaja com o sistema: No terminal do cliente, digite a palavra relatório para receber o arquivo do sistema ou envie qualquer outro texto para testar a resposta de erro.
